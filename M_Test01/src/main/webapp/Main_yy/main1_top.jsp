				...
				<td><table class="table">
						<tr height="100">
							<td><a href="main1_top.jsp"><img height="100"
									src="./img_yy/mantis.jpg" alt="로고 위치" /></a></td>
							...
							<td class="td_cen"><a href="main1_top.jsp?mainNum=5">나의
									강의실</a></td>
							<td class="td_cen"></td>
							<td class="td_img"><a href="main1_top.jsp?mainNum=6"><i
									class="fas fa-cart-shopping"></i></a></td>
							<td class="td_img"><a href="../user_jm/Login.jsp"><img
									src="./img_yy/login.png" alt="로그인" class="loginicon"></a></td>
						</tr>
					</table></td>
			</tr>
			<!-- 내용 -->
