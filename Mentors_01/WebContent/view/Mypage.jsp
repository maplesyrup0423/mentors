					...
					<div class = "div_box" >
						...
						<table class="account_info_table">
							...
							<tr>
								...
								onClick="location.href='Mentors_Main.jsp?mainNum=12'"/></td>
							</tr>
					...
					<div class = 'mypage_button'>
						<table>
							<tr >
								...
								onclick="location.href='Mentors_Main.jsp?mainNum=10'"/></td>
								
								<td><input class = "change_account" type="button" value = "정보수정"
								onClick="location.href='Mentors_Main.jsp?mainNum=11'"/></td>
							</tr>
						</table>
					</div>
				</td>
